 ...
 * @author Thinh
 */
public class ProductMangerrClient extends javax.swing.JFrame{

    /**
     * Creates new form ProductMangerrClient
     */
    Thread thread;

    public ProductMangerrClient() throws RemoteException {
        initComponents();
        Registry registry = LocateRegistry.getRegistry("localhost", 1088);
        try { 
            ProductManagerInterface chat = (ProductManagerInterface) registry.lookup("ProductManager");
        } catch (NotBoundException ex) {
            Logger.getLogger(ProductMangerrClient.class.getName()).log(Level.SEVERE, null, ex);
        } catch (AccessException ex) {
            Logger.getLogger(ProductMangerrClient.class.getName()).log(Level.SEVERE, null, ex);
        }
        P_ViewProduct home = new P_ViewProduct();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductMangerrClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {      
                ProductMangerrClient a = null;
                try {
                    a = new ProductMangerrClient();
                } catch (RemoteException ex) {
                    Logger.getLogger(ProductMangerrClient.class.getName()).log(Level.SEVERE, null, ex);
                }
                a.setVisible(true);                
