...
Go
Insert into Books(BookID, Title,Author,Category,Keyword) values('B0001',N'Lập trình Java',N'Ngô Trung Việt','Lập trình','Java')	
Insert into Books(BookID, Title,Author,Category,Keyword) values('B0002',N'Lập trình Python',N'Nguyễn Thành Thủy','Lập trình','Python')	
